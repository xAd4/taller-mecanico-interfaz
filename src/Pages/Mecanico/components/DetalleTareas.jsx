    ...
    <>
      <Layout>
        {isLoadingTareasAsignadas ? (
          ...
          tareasAsignadas.map((tareaAsignada) => (
              ...
              <div>
                <div className="container-fluid px-4 py-3">
                  ...
                  <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 gap-3">
                    ...
                    <div>
                      <h1 className="h2 fw-bold text-primary mb-1">
                        ...
                        Detalles de la Tarea #{tareaAsignada?.id}
                      </h1>
                      <p className="text-muted mb-0">
                        Estado:{" "}
                        <Badge
                          bg={
                            tareaAsignada?.estado_de_trabajo === "pendiente"
                              ? "warning"
                              : "success"
                          }
                    ...
                    <div className="bg-light p-3 rounded shadow-sm">
                      ...
                      <p className="mb-1">
                        ...
                        {tareaAsignada?.orden.cliente.nombre}
                      </p>
                      <p className="mb-1">
                        <strong>Email:</strong>{" "}
                        <a
                          href={`mailto:${tareaAsignada?.orden.cliente.email}`}
                        >
                          {tareaAsignada?.orden.cliente.email}
                        </a>
                      </p>
                      <p className="mb-1">
                        <strong>Teléfono:</strong>{" "}
                        {tareaAsignada?.orden.cliente.telefono}
                      </p>
                      <p className="mb-0">
                        <strong>Domicilio:</strong>{" "}
                        {tareaAsignada?.orden.cliente.domicilio}
                      </p>
                    </div>
                    ...
                    <div className="bg-light p-3 rounded shadow-sm">
                      ...
                      <p className="mb-1">
                        ...
                        {tareaAsignada?.orden.vehiculo.marca}{" "}
                        {tareaAsignada?.orden.vehiculo.modelo}
                      </p>
                      <p className="mb-1">
                        <strong>Matrícula:</strong>{" "}
                        {tareaAsignada?.orden.vehiculo.matricula}
                      </p>
                      <p className="mb-1">
                        <strong>Kilometraje:</strong>{" "}
                        {tareaAsignada?.orden.vehiculo.kilometraje} km
                      </p>
                      <p className="mb-1">
                        <strong>Color:</strong>{" "}
                        {tareaAsignada?.orden.vehiculo.color}
                      </p>
                      <p className="mb-1">
                        <strong>Nro Serie:</strong>{" "}
                        {tareaAsignada?.orden.vehiculo.numero_de_serie}
                      </p>
                      <p className="mb-0">
                        <strong>Nro Motor:</strong>{" "}
                        {tareaAsignada?.orden.vehiculo.numero_de_motor}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="card shadow-sm mb-4">
                    <div className="card-body" key={tareaAsignada?.id}>
                      <Row>
                        <Col md={6}>
                          <p className="mb-2">
                        ...
                        <Col md={6}>
                          <p className="mb-2">
                            ...
                            {tareaAsignada?.orden.recepcion}
                          </p>
                          <p className="mb-2">
                            <strong>Fecha prometida: </strong>
                            {tareaAsignada?.orden.prometido ||
                              "Sin fecha definida"}
                          </p>
                          <p className="mb-2">
                            <strong>Cambio de aceite: </strong>
                            {tareaAsignada?.orden.cambio_de_aceite
                              ? "Sí"
                              : "No"}
                          </p>
                          <p className="mb-2">
                            <strong>Cambio de filtro: </strong>
                            {tareaAsignada?.orden.cambio_de_filtro
                              ? "Sí"
                              : "No"}
                          </p>
                        </Col>
                      ...
                      {tareaAsignada?.notificacion_al_cliente && (
                  ...
                  <div className="mt-4 p-4 bg-light rounded-3 shadow-sm">
                    <Row className="align-items-center">
                      <Col md={8}>
                        ...
                        <p className="mb-0">
                          <strong>Responsable: </strong> ID #
                          {tareaAsignada?.mecanico_id} -{" "}
                          {tareaAsignada?.mecanico.name}
                        </p>
                      </Col>
                    </Row>
                  </div>
                  ...
                  >
                    ...
                    <tbody>
                      <tr key={tarea?.id}>
                        ...
                        <td className="text-center">
                          {renderStatusIcon(
                            tarea?.tren_delantero.articulaciones
                          )}
                        </td>
                        <td className="text-center">
                          {renderStatusIcon(tarea?.tren_delantero.conv2)}
                  ...
                  >
                    ...
                    <tbody>
                      <tr key={tarea?.id}>
                        ...
                        <td className="text-center">
                          {renderStatusIcon(
                            tarea?.tren_delantero.estacionamiento
                          )}
                        </td>
                        <td className="text-center">
                          {renderStatusIcon(
                            tarea?.tren_delantero.numero_cricket
                          )}
                        </td>
                      </tr>
                    </tbody>
                  ...
                  >
                    ...
                    <tbody>
                      <tr key={tarea?.id}>
                        ...
                        <td className="text-center">
                          {renderStatusIcon(
                            tarea?.tren_delantero.traseros_derechos
                          )}
                        </td>
                        <td className="text-center">
                          {renderStatusIcon(
